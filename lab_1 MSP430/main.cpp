...
//функция циклического сдвига shift_value: 0 - text, 1 - key
void make_shift(uint8_t(&shift_value)[4])
{
    ...
    shift_value[0] = shift_data & 0x000000FF;
    shift_value[1] = (shift_data & 0x0000FF00) >> 8;
    shift_value[2] = (shift_data & 0x00FF0000) >> 16;
    shift_value[3] = (shift_data & 0xFF000000) >> 24;
}
